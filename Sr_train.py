...
n=50
lr_list = os.listdir(r"C:\Users\rudra\OneDrive\Desktop\SoC\SRGANs\examples\lr_images")[:n]

lr_images = []
for img in lr_list:
    img_lr = cv2.imread(r"C:\Users\rudra\OneDrive\Desktop\SoC\SRGANs\examples\lr_images\\" + img)
    img_lr = cv2.cvtColor(img_lr, cv2.COLOR_BGR2RGB)
    lr_images.append(img_lr)   


hr_list = os.listdir(r"C:\Users\rudra\OneDrive\Desktop\SoC\SRGANs\examples\hr_images")[:n]
   
hr_images = []
for img in hr_list:
    img_hr = cv2.imread(r"C:\Users\rudra\OneDrive\Desktop\SoC\SRGANs\examples\hr_images\\" + img)
